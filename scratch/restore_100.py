...
for i in range(100):
    ...
    c.execute('INSERT INTO measurements (visit_id, data) VALUES (?, ?)', (v_id, json.dumps(m_data, ensure_ascii=False)))

conn.commit()
conn.close()
print("REFRESHED_SERIES_100_PATIENTS")
