...
def setup_test_clinic():
    ...
    master_path = '/root/medeye/data/master.db' if os.path.exists('/root/medeye/data/master.db') else MASTER_DB
    clinic_db_path = '/root/medeye/data/clinic_test.db' if os.path.exists('/root/medeye/data') else 'clinic_test.db'
